...
function actualizarBotonRadio() {
    ...
    if (btn) {
        if (modoActual === "radio") {
            btn.style.backgroundColor = "#FFD70050";   // dorado intenso para modo radio
            btn.style.boxShadow = "0 0 12px rgba(255, 215, 0, 0.8)"; // halo dorado
        } else {
...
function actualizarBarraVolumen(volume) {
    ...
    const activeColor = '#FFD700';   // dorado intenso
    const inactiveColor = '#B8860B'; // dorado oscuro (goldenrod)
