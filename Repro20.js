...
function cargarTracksDesdeJSON() {
    fetch("Repro20.json")
        ...
        .then(data => {
            ...
            // 🔑 CRÍTICO: Llama a activarReproduccion(0) solo para cargar metadatos y SRC.
            activarReproduccion(0, "initial-load"); 
            generarListaModal();
            console.log("✅ Pistas cargadas. Audio src preparado.");
        })
        .catch(err => {
...
// ===============================
// 🪟 FUNCIÓN ABRIR/CERRAR MODAL (VERSIÓN LIMPIA)
// ===============================
function toggleModal(show) {
    ...
    if (show) {
        ...
        // CRÍTICO: Llama a la función que tiene la lógica dual (Radio/Local)
        generarListaModal(); 
