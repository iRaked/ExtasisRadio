...
preloadBase.src = "assets/covers/Vinyl-Disc-FX.png";
...
audio.addEventListener("ended", () => {
  ...
  if (repeatMode === "list") {
    ...
    audio.play().then(() => {
      discImg.src = track.cover || "assets/covers/Vinyl-Disc-FX.png";
      discImg.classList.add("rotating");
  ...
  if (autoplayEnabled) {
    ...
    audio.play().then(() => {
      discImg.src = nextTrack.cover || "assets/covers/Vinyl-Disc-FX.png";
      discImg.classList.add("rotating");
      iconPlay.classList.add("hidden");
      iconPause.classList.remove("hidden");
      actualizarEstadoCaratula();
...
audio.addEventListener("pause", () => {
  ...
  discImg.src = "assets/covers/Vinyl-Disc-FX.png";
