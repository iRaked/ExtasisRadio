...
document.addEventListener('click', () => {
  ...
  if (surface && typeof $(surface).ripples === 'function') {
    try {
      // Activación simbólica: genera una onda al hacer clic
      $(surface).ripples('drop', surface.clientWidth / 2, surface.clientHeight / 2, 20, 0.04);
    } catch (e) {
      console.warn('No se pudo activar el efecto ripple:', e);
    }
  }
});
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 03 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Método adaptado para cargar una imagen como textura base
loadImageTexture: function() {
  gl = this.context;

  // Extraer la URL de la imagen desde el estilo CSS
  ...
  image.crossOrigin = "anonymous"; // Por si la imagen está en CDN
...
render: function() {
	...
	// Usar textura de imagen previamente cargada (no se actualiza por frame)
    gl.bindTexture(gl.TEXTURE_2D, this.backgroundTexture);

	// Usar textura de imagen previamente cargada
gl.bindTexture(gl.TEXTURE_2D, this.backgroundTexture);
...
set: function(property, value) {
  switch (property) {
    ...
    case 'imageUrl':
      this.imageUrl = value;
      this.loadImageTexture(); // ← adaptado para imagen
      break;
  }
}
};
